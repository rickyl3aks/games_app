      ...
      {game.parent_platforms &&
        game.parent_platforms.map((e: any) => {
          switch (e.platform.name) {
            case "Xbox":
              return (
                <svg key={e.platform.name} xmlns="http://www.w3.org/2000/svg" style={{ width: 15, marginLeft: 5 }} viewBox="0 0 512 512">
            ...
            case "PlayStation":
              return (
                <svg key={e.platform.name} xmlns="http://www.w3.org/2000/svg" style={{ width: 15, marginLeft: 5 }} viewBox="0 0 576 512">
            ...
            case "iOS":
              return (
                <svg key={e.platform.name} xmlns="http://www.w3.org/2000/svg" style={{ width: 15, marginLeft: 5 }} viewBox="0 0 384 512">
            ...
            case "Linux":
              return (
                <svg key={e.platform.name} xmlns="http://www.w3.org/2000/svg" style={{ width: 15, marginLeft: 5 }} viewBox="0 0 448 512">
            ...
            case "Nintendo":
              return (
                <svg key={e.platform.name} xmlns="http://www.w3.org/2000/svg" style={{ width: 15, marginLeft: 5 }} viewBox="0 0 640 512">
